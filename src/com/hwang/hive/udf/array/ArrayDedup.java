 ...
 */
public class ArrayDedup extends GenericUDF {
    ...
    public ObjectInspector initialize(ObjectInspector[] args)
        ...
        if (args.length != 1) {
            throw new UDFArgumentException("array_dedup expects 1 argument");
        }
        if (args[0].getCategory() != ObjectInspector.Category.LIST) {
            throw new UDFArgumentException("array_dedup expects an array as argument, got " + args[0].getTypeName());
        }
        ...
        if (tmpElementsInspector.getCategory() != ObjectInspector.Category.LIST) {
            throw new UDFArgumentException("array_dedup expects array<>");
        }
