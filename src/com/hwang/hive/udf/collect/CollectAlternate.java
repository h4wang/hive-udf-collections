package com.hwang.hive.udf.collect;
...
public class CollectAlternate extends AbstractGenericUDAFResolver
{
    @Override
            ...
            throws SemanticException
    {
        ...
        return new CollectAlternateEvaluator();
    }
 
    public static class CollectAlternateEvaluator extends GenericUDAFEvaluator
    {
                ...
                throws HiveException
        {
            ...
            if (p != null)
            {
                ...
                if(agg.container.contains(p)){
                if(agg.container.lastIndexOf(p)!= (agg.container.size()-1))
